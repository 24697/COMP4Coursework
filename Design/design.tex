...
\begin{tabular}{|p{1.5cm}|p{1.5cm}|l|l|l|p{2.5cm}|}
	...
	EventID & Integer & 1 - 9999 & & & \\ \hline
	Age & Integer & 10 - 99  & & & \\ \hline
	Date & Sting & 10 Charters & & & \\ \hline
	Event Points & Integer & 0 - 20 & & & \\ \hline
	EventType & Sting & Up To 10 Charters & & & \\ \hline
	Event PointType & Sting &  & & & \\ \hline
	Club Referance & Integer & & & & \\ \hline
	RiderID & Integer & & & & \\ \hline
	Forename & Sting & & & & \\ \hline
	Surname & Sting & & & & \\ \hline
	Handicap Mod & Sting & & & & \\ \hline
	Event PointsID & Integer & & & & \\ \hline
	Club & Sting & & & & \\ \hline
	RecordID & Integer & & & & \\ \hline
	RideTime & Sting & & & & \\ \hline
	CourceID & Integer & & & & \\ \hline
	Cource Code & Sting & & & & \\ \hline
	Cource Distance & Integer & & & & \\ \hline
	Date Joined & Sting & & & & \\ \hline
	DateLeft & Sting & & & & \\ \hline
	Event ReferanceID & Integer & & & & \\ \hline
	Event TypeID & Integer & & & & \\ \hline
	ClubID & Integer & & & & \\ \hline
	Laps & Integer & & & & \\ \hline
\end{tabular}
