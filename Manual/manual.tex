...
There are few limitation of the current system, one is that the edit funtion is not implemented in the main application, this was due to lack of time however the edit funtion was implemented in the CLI so you can edit data using the CLI.
