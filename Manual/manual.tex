...
\caption{Windows Security Warning} \label{fig:PyQtISP2}
\end{figure}
...
\end{figure}
\item read the license agreement and if you agree click the I Agree button, if you choose not to agree the system will not work
\begin{figure}[H]
\includegraphics[width=\textwidth]{./Manual/PyQtInstall/Part4.png}
\caption{PyQt setup wizard} \label{fig:PyQtISP4}
\end{figure}
\item Make sure that you install the full package of PyQt and click the next button
\begin{figure}[H]
\includegraphics[width=\textwidth]{./Manual/PyQtInstall/Part5.png}
\caption{PyQt setup wizard} \label{fig:PyQtISP5}
\end{figure}
\item Use the directory that have used for the Python install earlier, then click install
\begin{figure}[H]
\includegraphics[width=\textwidth]{./Manual/PyQtInstall/Part6.png}
\caption{PyQt setup wizard} \label{fig:PyQtISP6}
\end{figure}
\item Allow PyQt a few moments to install
\item The click the finish button to close the setup wizard
\begin{figure}[H]
...
Note: If the field is not filled an error messages will appear when the "OK" button is pressed
...
Making regular updates would also be good for data recover, I would recommend making a backup every week and keeping the last 3 weeks of backups replacing the oldest back up each week. 
