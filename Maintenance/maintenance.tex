...
\subsubsection{Python 3}
Some of the features that I used include the ablity to import from other python files and packages e.g. PyQt.
\subsubsection{IDLE}
I chouse to use IDLE as is has spesific highlighting for python and I can run the code from IDLE to test it with out, complying it.
\subsubsection{PyQt}
PyQt was used as I found that because Python is an object orented language it was easy to build the user interface in a way that was inderstande.
\subsubsection{SQLite 3}
I used SQLite 3 to create a relational database and to search across multipul tables.
\subsubsection{SQL Inspector}
...
\section{Settings}
For the system to work as expected you will need to make sure that you have any version of Python 3 and a vershion of PyQt that is compatible with python 3. All other packegaes used come with the standard libarby in python 3.
